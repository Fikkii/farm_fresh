  ...
  return (
    <div>
      <div className="relative">
        ...
        <div className="absolute bottom-0 left-0 z-10 flex gap-2 flex-col p-[40px]">
      ...
      <div className="flex flex-col md:grid grid-cols-2 gap-4 mt-6">
        <div className="flex flex-col gap-6">
          <div className="flex gap-5 items-center">
            ...
            <div id="direction">
              <h2 className="text-[26px] font-bold">{farm[0].location || "No Location for this farm"}</h2>
          ...
          <div>
            <h2 className="text-[26px] font-bold">About The Farm</h2>
            <div className="text-[#757575]">
