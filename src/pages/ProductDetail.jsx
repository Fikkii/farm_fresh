            ...
            <div>
              ...
              <div className="flex items-center font-bold gap-1">
                <div className="flex items-center">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} xmlns="http://www.w3.org/2000/svg" fill="#EAB308" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#EAB308" className="size-4">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
                    </svg>
                  ))}
                </div>
                  {product.rating} (120 Reviews)
                <span className="text-[#66BB6A] font-normal ml-2">Same Day Delivery</span>
              </div>
            </div>
            <div className="p-[24px] bg-[#F2F6F2] shadow-sm rounded-lg">
              <h2 className="text-[34px] font-bold mb-2">${product.price}<span className="font-normal text-sm text-gray-400">/ kg</span></h2>
            </div>
            <div className="p-[24px] flex flex-col gap-[16px]">
              <div className="flex gap-4 items-center">
                ...
                <div>
                  ...
                  <div className="text-[16px] font-bold">{product.farms?.farmName || "Local Farm"}</div>
                </div>
              </div>
              <div className="flex gap-4 items-center">
                ...
                <div>
                  ...
                  <div className="text-[16px] font-bold">{product.farms?.location || "N/A"}</div>
                </div>
              </div>
              <div className="flex gap-4 items-center">
                ...
                <div>
                  ...
                  <div className="text-[16px] font-bold">{new Date(product.$updatedAt).toLocaleDateString()}</div>
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-[24px]">
              <div className="flex flex-wrap gap-2 items-center w-full">
                <div className="flex gap-1 items-center">
                  ...
                  <Input 
                    readOnly
                    classNames={{ base: "w-[60px]", input: "text-center" }} 
                    value={localQuantity} 
                  />
                  <Button 
                    className="text-white min-w-[40px]" 
